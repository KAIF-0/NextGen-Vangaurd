...
const TESTIMONIALS = [
  {
    ...
    content: "The mentorship I received was invaluable. My mentor helped me land my dream job in AI.",
  ...
  },
  {
    ...
    content: "The structured roadmap and expert guidance helped me transition into AI seamlessly.",
  ...
  },
  {
    ...
    content: "Found amazing mentors who guided me through my research projects.",
...
const ROADMAP_STEPS = [
  {
    ...
    description: "Share your AI projects and get detailed feedback from experts",
    icon: CheckCircle2,
    color: "blue"
  },
  {
  ...
  {
    title: "Get Funded",
    description: "Top projects get funding opportunities and industry connections",
    icon: Rocket,
    color: "pink"
  }
]
...
function TestimonialCard({ testimonial }: { testimonial: typeof TESTIMONIALS[0] }) {
  return (
    <div className="bg-black/30 backdrop-blur-md rounded-xl p-6
      ...
      <p className="mt-4 text-blue-100/80 italic">"{testimonial.content}"</p>
    </div>
  )
}
      ...
      <section className="min-h-[calc(100vh-4rem)] flex flex-col items-center justify-center p-4 text-center">
        <div className="bg-black/30 backdrop-blur-md rounded-2xl p-8 md:p-12
          ...
          <p className="mt-6 text-xl text-blue-100/90 max-w-2xl mx-auto">
            Connect with industry experts and accelerate your career through our innovative AI-matching system.
          </p>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {ROADMAP_STEPS.map((step, index) => (
              <div key={index} className="bg-black/20 backdrop-blur-sm rounded-xl p-6
                                        border border-blue-500/20 hover:border-blue-500/40
                                        transform hover:-translate-y-1 transition-all duration-300">
      ...
      <section className="py-24 px-4 bg-black/10">
        <div className="max-w-6xl mx-auto">
          ...
          <p className="text-blue-100/80 text-center mb-12 max-w-2xl mx-auto">
            Hear from our community members who have transformed their careers through our platform
          </p>
          <div className="grid md:grid-cols-3 gap-8">
