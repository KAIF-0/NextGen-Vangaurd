...
const DUMMY_EVENTS: Event[] = [
  {
    ...
    description: "Join leading healthcare professionals and AI experts discussing the future of medical diagnostics.",
    date: "2024-04-15",
  ...
  },
  {
    ...
    description: "Hands-on workshop covering advanced ML techniques and practical implementations.",
    date: "2024-03-20",
